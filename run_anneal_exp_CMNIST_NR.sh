...
#SBATCH --job-name=Anneal_sweep_CMNIST_no_reset
#SBATCH --output=Anneal_sweep_CMNIST_no_reset.out
#SBATCH --error=Anneal_sweep_error_CMNIST_no_reset.out
#SBATCH --ntasks=1
...
python3 -m domainbed.scripts.anneal_sweep launch\
       ...
       --dataset ColoredMNIST\
       --data_dir $SLURM_TMPDIR/MNIST/\
       --output_dir $SLURM_TMPDIR/misc/ColoredMNIST_NR_results/\
